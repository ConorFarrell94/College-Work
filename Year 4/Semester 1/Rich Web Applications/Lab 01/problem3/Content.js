...
// TODO: Some images seem to be inverted, gotta figure out how to stop this, doesn't happen to all of them
document.querySelector("html").style.filter = "invert(1)"
let media = document.querySelectorAll("img, picture, video, background-image");
media.forEach((mediaItem) => {
    mediaItem.style.filter = "invert(1)"
})
const myStyle = document.createElement("style");
myStyle.innerText = 'body { font-family: Comic Sans MS; }';
